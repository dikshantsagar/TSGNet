...
class ElectronAbTrainDataset(Dataset):
    def __init__(self, dataset_dir='/baldig/physicsprojects/electron_microscopy', downsample_rate=1):
        print("Loading Data")
        self.data = np.load(Path(dataset_dir) / 'Training_ab.npy', mmap_mode='r')
        print("Data Loaded!")
...
class ElectronAbTestDataset(Dataset):
    def __init__(self, dataset_dir='/baldig/physicsprojects/electron_microscopy', downsample_rate=1):

        print("Loading Data")
        self.data = np.load(Path(dataset_dir) / 'Test_ab.npy', mmap_mode='r')
        print("Data Loaded!")
